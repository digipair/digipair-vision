// https://github.com/aframevr/aframe/pull/4959
/* global DeviceOrientationEvent, AFRAME  */
 ...
 */
module.exports.Component = registerComponent('look-controls-custom', {
  ...
  setupMagicWindowControls: function () {
    ...
    if (
      ...
      utils.device.isMobileDeviceRequestingDesktopSite()
    ) {
  ...
  /**
   * Translate touch move to Y-axis and X-axis rotation.
   */
